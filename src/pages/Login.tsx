    ...
    <AuthLayout>
      <Card className="w-full border-0 bg-white/90 dark:bg-gray-800/90 backdrop-blur-md shadow-xl rounded-2xl">
        <CardHeader className="text-center p-8">
          <CardTitle className="text-3xl font-extrabold text-gray-800 dark:text-white mb-2">Welcome Back!</CardTitle>
          <p className="text-muted-foreground text-lg">Sign in to your adventure</p>
        </CardHeader>
